...
// Системный скрипт админки, подгружает скрипты административной панели или выдает менюшку админки
// Ещё полностью не доделан, так что сильно не пугайтесь если что-то плохое увидите
