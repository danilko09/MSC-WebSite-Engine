...
// Библиотекарь CMS
// Основная функция - подгрузка основных библиотек перед началом работы CMS
// и динамическая подгрузка установленных библиотек
// так-же есть возможность добавить в "автозагрузку" свои библиотеки,
// для этого добавьте в таблицу 'lib' свою библиотеку.
// Пока на стадии разработки, позже будет админ-интерфейс для редактирования "автозагрузки"
